    ...
    <Layout showHeader={true} showFooter={true}>
      <div className="completedash">
        ...
        <div className="content">
          <h1>Welcome to Virtual Book Shelf!, {auth?.user?.name}</h1>
          {activeSection === "profile" && (
            <div className="dashboard-section profile-section" >
              <h2 className="dashboard-profiletxt">Profile</h2>
              <div>
                <p className="dashboard-profiletxt1"><strong>Name:</strong> {auth?.user?.name}</p>
                <p className="dashboard-profiletxt1"><strong>Email:</strong> {auth?.user?.email}</p>
                <p className="dashboard-profiletxt1"><strong>Phone:</strong> {auth?.user?.phone}</p>
              </div>
            </div>
          )}
